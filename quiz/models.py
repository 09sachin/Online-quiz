...
class Quiz(models.Model):
    ...
    rule1 = models.CharField(max_length=300, blank=True)

    rule2 = models.CharField(max_length=300, blank=True)

    rule3 = models.CharField(max_length=300, blank=True)

    rule4 = models.CharField(max_length=300, blank=True)

    rule5 = models.CharField(max_length=300, blank=True)
...
class Sitting(models.Model):
    ...
    def questions_with_user_answers(self):
        return {
            q: q.user_answer for q in self.get_questions(with_answers=False)
        }
